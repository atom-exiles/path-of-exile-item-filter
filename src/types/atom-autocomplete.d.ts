...
declare module "atom-autocomplete" {
  ...
  interface SuggestionInsertedEvent {
    editor: TextEditor;
  ...
  */
  interface Suggestion<T extends { text: string }|{ snippet: string }> {
    /**
  ...
  interface TextSuggestion extends Suggestion<TextSuggestion> {
    /** The text which will be inserted into the editor, in place of the prefix. */
    text: string;
  }

  interface SnippetSuggestion extends Suggestion<SnippetSuggestion> {
    /**
