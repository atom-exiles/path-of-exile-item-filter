...
// Project: https://github.com/atom/autocomplete-plus

// Type definitions for the few data structures referenced in the autocomplete+
// documentation found here:
//  https://github.com/atom/autocomplete-plus/wiki/Provider-API

declare namespace Autocomplete {
  /** Objects that appear as parameters to functions, broken off for easy
   *  function definition (both here and in the usage code). */
  namespace Params {
  ...
  type TextSuggestions = Array<TextSuggestion>;

  interface SnippetSuggestion extends Suggestion {
    /** A snippet string. This will allow users to tab through function arguments or other options. */
    snippet: string
  }
  type SnippetSuggestions = Array<SnippetSuggestion>;
  ...
  interface Provider {
     ...
     *  displayed to the user. Returning a Promise of an array of suggestions is also supported. */
    getSuggestions(params: Params.SuggestionRequest): Suggestions|Promise<Suggestions>;
     ...
     *  into the buffer. */
    onDidInsertSuggestion?: (params: Params.SuggestionInserted) => void;
