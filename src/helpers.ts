...
export function isItemFilter(editor: AtomCore.TextEditor) {
...
export namespace Guards {
  export namespace FilterElements {
    ...
    export function isLinkedSocketsRule(line: Filter.Line): line is Filter.Element.LinkedSocketsRule {
      if(isFilterRule(line)) {
    ...
    export function isSetBorderColorRule(line: Filter.Line): line is Filter.Element.SetBorderColorRule {
    ...
    export function isSetTextColorRule(line: Filter.Line): line is Filter.Element.SetTextColorRule {
      if(isActionRule(line)) {
    ...
    export function isSetBackgroundColorRule(line: Filter.Line): line is Filter.Element.SetBackgroundColorRule {
      if(isActionRule(line)) {
        if((<Filter.Element.SetBackgroundColorRule>line).actionName === "SetBackgroundColor") return true;
        else return false;
      } else {
        return false;
      }
    ...
    export function isPlayAlertSoundRule(line: Filter.Line): line is Filter.Element.PlayAlertSoundRule {
      if(isActionRule(line)) {
  ...
  export function isTextSuggestion(suggestion: Autocomplete.Suggestion):
      suggestion is Autocomplete.TextSuggestion {
    return (<Autocomplete.TextSuggestion>suggestion).text !== undefined;
  }

  /** Returns whether or not the given suggestion is a SnippetSuggestion. */
  export function isSnippetSuggestion(suggestion: Autocomplete.Suggestion):
      suggestion is Autocomplete.SnippetSuggestion {
    return (<Autocomplete.SnippetSuggestion>suggestion).snippet !== undefined;
  }
}
